...
I was at a conference recently and saw a statistic that only 5% of AI products make it to production. That seems shocking, but before we start KPI-hacking, we should pause and see if the KPI is a true measure of what we are trying to achieve, or just a proxy.

## Innovation

Innovation is a tricky thing. I think a lot of what happens in large corporations is something more like adaptation than innovation. Some examples of this are dashboards, automated messaging and intranets. These are all valuable projects that require creativity and hard work, but they are ideas that people bring with them from role to role or firm to firm. They are also generally validated by social proof more than by careful exploration of potential benefits, and users generally have already dealt with versions of the idea in some form already.

AI applications have basically never existed before. Even the current winners are not proven and may only work in very narrow contexts, for poorly understood reasons, so social proof alone is not a great measure for the success of projects across firms or teams.

The biggest implication of this is that user input in the development process for AI products is not nearly as valuable as it is for traditional business products. Henry Ford might not have said it, but based on my interactions with business users this rings fairly true:
